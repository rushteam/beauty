...
// 两个来源自动合并:
//   - ldflags 注入的包级变量(优先):
//     go build -ldflags "-X github.com/rushteam/beauty/pkg/foundation/buildinfo.version=1.2.3 \
//     -X github.com/rushteam/beauty/pkg/foundation/buildinfo.commit=$(git rev-parse HEAD) \
//     -X github.com/rushteam/beauty/pkg/foundation/buildinfo.buildTime=$(date -u +%FT%TZ)"
